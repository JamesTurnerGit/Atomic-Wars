...
export default class WindowManager {
  ...
  // setupWindows(language,apiObject) {
  //   apiObject.then((data) => {
  //       var activeKata = this._createWindows().then((kata) => {
  //         this._setupDescriptionWindow(language,kata,data);
  //         this._setupCodeWindow(language,kata,data);
  //         this._setupTestWindow(language,kata,data);
  //     })
  //   })
  // }
  //
